...
> = {
    test?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<QueryTestArgs, 'id'>
    >;
    spotPrice?: Resolver<
        Array<ResolversTypes['SpotPrice']>,
        ParentType,
        ContextType
    >;
};

export type SpotPriceResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SpotPrice'] = ResolversParentTypes['SpotPrice']
> = {
